...
package body NDFAs is
   ...
   procedure Insert_State
     (A : access NDFA; N : in States.State_Name; S, F : in Boolean) is
   begin
   ...
   procedure Generate_Transitions
     (N : access States.State; T : access Transition_Array) is
   begin
   ...
   begin
      Put_Line("States:");
      for I in  0 .. A.Num_States - 1 loop
         States.Debug (A.States (I));
      end loop;
      New_Line;
      Put_Line("Transitions:");
      for I in  0 .. A.Num_Transitions - 1 loop
         Transitions.Debug (A.Transitions (I));
         New_Line;
      end loop;
      New_Line;
   end Debug;
