with Array_Priority_Queue;
with Ada.Text_IO; use Ada.Text_IO;
with Ada.Integer_Text_IO; use Ada.Integer_Text_IO;
procedure PQA is
--
--  Test abstract data type for priority queue.
--
  package Priority_Queue renames Array_Priority_Queue;
...
begin
  ...
  --  Priority_Queue.Put(17, Q);  -- Remove comment to test overflow
