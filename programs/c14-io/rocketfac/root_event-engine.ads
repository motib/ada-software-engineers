...
package Root_Event.Engine is
  ...
  function Create(Params: not null access Parameters) return Engine_Event;
  procedure Simulate(E: in Engine_Event);

  type Main_Engine_Event is new Engine_Event with private;
  function Create(Params: not null access Parameters) return Main_Engine_Event;
  
  type Aux_Engine_Event is new Engine_Event with private;
  function Create(Params: not null access Parameters) return Aux_Engine_Event;
